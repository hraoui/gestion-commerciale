            ...
            @csrf
                ...
                <div class="row">
                    <div class="form-group col">
                        ...
                        <input id="stock" type="number" name="stock" min="0" placeholder="Entrer quantité"  value="{{old('stock')}}" class="form-control">
                    </div>
                    <div class="form-group col" >
                ...
                <div class="row">
                    <div class="form-group col ">
                        ...
                        <textarea id="description" name="description" class="form-control" cols="30" rows="10">Description</textarea>
                    </div>
                </div>
